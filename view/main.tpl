...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        ...
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="index.php?products.php">Каталог товарів</a>
            </li>
        </ul>
        <div class="my-2 my-lg-0 form-inline">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link disabled" href="index.php?basket.php">Корзина</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link disabled" href="index.php?calc.php">Калькулятор</a>
                </li>
            </ul>
        </div>
    </div>
